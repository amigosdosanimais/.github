                ...
                <div className={styles.container}>
                    ...
                    <Menu className={styles.menu}>
                        <MenuItem className={styles.menuitem} rootStyles={{['.'+ menuClasses.button]:{'&:hover': {
                            ...
                            <picture className={styles.menuimage}>
                                <svg xmlns="http://www.w3.org/2000/svg"  width="25" height="25" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" fill="none" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <Menu className={styles.footer}>
                        <div className={styles.profile}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"  width="50" height="50" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
