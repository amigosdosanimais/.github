        ...
        <div className={styles.principal} >           
            <Sidebar className={styles.sidebar} collapsed={collapsed} >              
                <div className={styles.container}>
                    ...
                    <Menu className={ collapsed? styles.menuCollapse: styles.menu}>

                        <MenuItem className={ collapsed?styles.menuitemCollapse: styles.menuitem} rootStyles={{[`.${menuClasses.button}`]:{'&:hover': {backgroundColor: '#293020 !important', borderRadius:"6px", color:"#F3F7ED", stroke:"#F3F7ED"}}}}>

                                <picture className={collapsed?styles.menuimageCollapse: styles.menuimage}>
                                    <svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#888e80" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <MenuItem className={collapsed?styles.menuitemCollapse: styles.menuitem} rootStyles={{[`.${menuClasses.button}`]: {'&:hover': {backgroundColor: '#293020 !important', borderRadius:"6px", color:"#F3F7ED"},},}}>
                            <picture className={collapsed?styles.menuimageCollapse: styles.menuimage}>
                                <svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg"  width="25" height="25" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#888e80" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                        ...
                        <MenuItem className={ collapsed?styles.menuitemCollapse: styles.menuitem} rootStyles={{[`.${menuClasses.button}`]:{'&:hover': {backgroundColor: '#293020 !important', borderRadius:"6px", color:"#F3F7ED"}}}}>
                                ...
                                {collapsed? <></> :<p>Pessoas</p>}
                        </MenuItem>
                    </Menu>
                    <Menu className={styles.footer}>
                        <div className={styles.profile}>
                            <picture className={styles.imguser}>
                            <svg role="graphics-symbol" xmlns="http://www.w3.org/2000/svg"  width="36" height="36" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#888e80" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            ...
                            {collapsed?<></>: <div className={styles.contact}>
                                <h1>Johnny Doe</h1>
                                <p>johnnysdoe@example.com</p>
                            </div>}
                            {collapsed?<></>: <picture >
                                <a href="/">
                                    <svg className={styles.imglogout} role="graphics-symbol" xmlns="http://www.w3.org/2000/svg"  width="25" height="21" viewBox="0 0 24 24" strokeWidth="2" stroke="#F3F7ED" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
