import styles from './whatsZampetCard.module.css';

const WhatsZampetCard = () => {
  return (
    <div className={styles.card}>
      ...
      <p className={styles.description}>
        ...
        Inibus ullamcorper, orci ligula consequat sapien, quis tempus turpis sapien a sapien.
        Aliquam elit nibh, laoreet quis congue vel, imperdiet vitae neque. Integer id dolor ac tellus fringilla faucibus.
        Nulla accumsan ligula in mattis luctus. Suspendisse sit amet nunc nisl. 
        Sed rutrum sem auctor sem convallis, in mollis dolor fermentum. Praesent. 
        Fringilla nibh quis molestie porta. Aenean commodo, nibh quis pretium finibus,
        urna urna ullamcorper tortor, eu scelerisque mauris arcu id ligula.
      </p>
    </div>
  );
...
export default WhatsZampetCard;
